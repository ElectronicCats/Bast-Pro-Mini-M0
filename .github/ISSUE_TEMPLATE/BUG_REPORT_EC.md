...
about: Report a bug or unexpected behavior while using the Bast Pro Mini M0 Board.
...
Any feedback/suggestions should be discussed on the [feedback section](https://github.com/ElectronicCats/Bast-Pro-Mini-M0/issues):
